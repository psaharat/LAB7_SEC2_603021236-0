package com.example.lab7dialogrv_sec1_603021236_0
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View){
        ...
        mDialogView.btnAdd.setOnClickListener{
            ...
            Toast.makeText(applicationContext, "The Student is added seccessfully", Toast.LENGTH_SHORT).show()
    ...
    fun testStudentData(){
        studentList.add(Student("603022122-1","Alice",20))
        studentList.add(Student("603022122-2","Bob",21))
    }
}
